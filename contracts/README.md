...
| Retrieval-Policy | `contracts/retrieval/` | YAML/JSON (geplant) | Merge Graph↔RAG (ADR-0009) |
...
- ⏳ Retrieval-Policy Graph↔RAG — [ADR-0009](../adr/ADR-0009-knowledge-graph-and-chroma-rag.md) (kein Chroma in KP)
